...
## Setup MyLinks
MyLinks is effectively a self hosted ChatGPT clone; it looks just like it. [Here is the GitHub](https://github.com/TrinhNgocThanh/mylinks.com.vn). It has support for almost every feature of the traditional ChatGPT site, but it stores all the accounts and messages in a MongoDB database and utilizes the API instead.

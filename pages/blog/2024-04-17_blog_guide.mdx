...
Before you begin, you'll need to fork and clone the website's repo located at: https://github.com/MyLinks-AI/librechat.ai
...
1. **Fork the Repository**: 
    - Navigate to the [MyLinks-AI GitHub repository](https://github.com/MyLinks-AI/librechat.ai).
...
3. **Set Upstream Remote**:
    - To keep your fork up-to-date with the original repository, you'll need to set the original repository as the upstream remote. Run the following commands:
      ```sh
      git remote add upstream https://github.com/MyLinks-AI/librechat.ai.git
      git fetch upstream
      ```

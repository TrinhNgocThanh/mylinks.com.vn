...
6. If you haven't done so already, start MyLinks normally.
7. In the `ngrok.exe` terminal, run the following command: `ngrok http 3080`

You will see a link that can be used to access MyLinks.
![ngrok-1](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/3cb4b063-541f-4f0a-bea8-a04dd36e6bf4)
...
5. If you haven't done so already, start MyLinks normally.
...
8. If you haven't done so already, start MyLinks normally.

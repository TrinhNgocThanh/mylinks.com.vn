---
title: HuggingFace
description: Easily deploy MyLinks on Hugging Face Spaces
---
...
**2.** Visit **[https://huggingface.co/spaces/MyLinks/template](https://huggingface.co/spaces/MyLinks/template)** and click on `Duplicate this Space` to copy the MyLinks template into your profile. 
...
> Note: It is normal for this template to have a runtime error, you will have to configure it using the following guide to make it functional.
  ...
  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/fd684254-cbe0-4039-ba4a-7c492b16a453)

**3.** Name your Space and Fill the `Secrets` and `Variables`
 
  >You can also decide here to make it public or private

  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/13a039b9-bb78-4d56-bab1-74eb48171516)
...
**1.** When you're done filling the `secrets` and `variables`, click `Duplicate Space` in the bottom of that window
  ...
  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/55d596a3-2be9-4e14-ac0d-0b493d463b1b)


**2.** The project will now build, this will take a couple of minutes

  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/f9fd10e4-ae50-4b5f-a9b5-0077d9e4eaf6)


**3.** When ready, `Building` will change to `Running` 

  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/91442e84-9c9e-4398-9011-76c479b6f272)

  And you will be able to access MyLinks!

  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/cd5950d4-ecce-4f13-bbbf-b9109e462e10)

## Update
  To update MyLinks, simply select `Factory Reboot` from the ⚙️Settings menu

  ![image](https://github.com/fuegovic/MyLinks/assets/32828263/66f20129-0ffd-44f5-b91c-fcce1932112f)
...
**🎉 Congratulation, you've sucessfully deployed MyLinks on Hugging Face! 🤗**

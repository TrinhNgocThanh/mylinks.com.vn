...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/05cf165b-d3d8-475a-93b3-254f3c63f59b)
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/2ad7b739-a3db-4744-813f-39af7dabfce7)
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/6baea405-8dfb-4d9d-9327-6e9ecf800471)
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/fbba1a38-95cd-4e8e-b813-04001bb82b25)
...
### **2. Create MyLinks Config and Environment files**

#### Config (librechat.yaml) File

Next, we create the [MyLinks Config file](/docs/configuration/librechat_yaml), AKA `librechat.yaml`, allowing for customization of the app's settings as well as [custom endpoints](/docs/configuration/librechat_yaml/ai_endpoints).
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/5e2f6627-8ca4-4fa3-be73-481539532ee7)
...
> If you are setting up a domain to be used with MyLinks, this compose file is using the nginx file located in client/nginx.conf. Instructions on this below in part V.
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/d8bbad29-6015-46ec-88ce-a72a43d8a313)

#### Sign up, log in, and enjoy your own privately hosted, remote MyLinks :)

![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/85070a54-eb57-479f-8011-f63c14116ee3)

![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/b3fc2152-4b6f-46f9-81e7-4200b76bc468)

## Part III: Updating MyLinks
...
```bash filename="Pull the latest MyLinks image""
...
However, I will show you what to edit on the MyLinks side for a custom domain with this setup.
...
To commit changes to a git branch, you will need to identify yourself on git. These can be fake values, but if you would like them to sync up with GitHub, should you push this branch to a forked repo of MyLinks, use your GitHub email
...
By default, this setup will pull the latest updates to the main branch of Librechat. If you would rather have the latest "stable" release, which is defined by the [latest tags](https://github.com/TrinhNgocThanh/mylinks.com.vn/releases), you will need to edit deploy-compose.yml and commit your changes exactly as above in Part V. Be aware that you won't benefit from the latest feature as soon as they come if you do so.

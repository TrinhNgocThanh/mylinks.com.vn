...
Contributions to the documentation are welcome! This guide explains how to contribute to the MyLinks documentation by writing and formatting new documentation. Our website is built with Nextra 3 and our docs use the `.mdx` format (augmented markdown).
...
- Fork the MyLinks Documentation repository: [https://github.com/MyLinks-AI/librechat.ai](https://github.com/MyLinks-AI/librechat.ai)

- Create a branch on your fork, name it properly, and link it to the original repository.

```sh filename="Download your MyLinks.ai branch"
...
<div style={{padding: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
  <div className="image-light-theme">
    <Image src="https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/cf0f3231-287a-407f-bd4d-3d5bad94e893" alt="ipad-light" width={1024} height={512} style={{borderRadius: "5px"}} />
  </div>

  <div className="image-dark-theme">
    <Image src="https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/a03ee02d-5099-4220-95b0-bfa2d3b00b4d" alt="ipad-dark" width={1024} height={512} style={{borderRadius: "5px"}} />
  </div>
</div>
```
...
<Callout title="Method A" emoji="🅰️" collapsible>
    ...
    ![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/c1612f93-a6c0-4af7-9965-9f83872cff00)
...
<Callout title="Method B" emoji="🅱️" collapsible>
    ...
    ![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/4f138ab4-31a5-4fae-a459-5335e5ff25a8)

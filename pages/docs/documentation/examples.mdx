...
<Tabs items={['Example', 'Code']}>
  <Tabs.Tab>
    <Carousel autoplay animationDuration="1500" perView="3">
      <img 
      src="https://github.com/danny-avila/MyLinks/assets/32828263/9b260f59-6acc-4fac-83b9-9d123d6b4a35" 
      alt="Slide 1"
      style={{ maxWidth: '75%', height: 'auto', borderRadius: '20px' }}
      />
      <img
      src="https://github.com/danny-avila/MyLinks/assets/32828263/d742c488-963a-4011-86f2-b6df184b70d1" 
      alt="Slide 2" 
      style={{ maxWidth: '75%', height: 'auto', borderRadius: '20px' }}
      />
      <img
      src="https://github.com/danny-avila/MyLinks/assets/32828263/5a338731-eb95-41ea-8327-f5e78b8cc157" 
      alt="Slide 3" 
      style={{ maxWidth: '75%', height: 'auto', borderRadius: '20px' }}
      />
    </Carousel>
...
<Tabs items={['Example', 'Code']}>
  <Tabs.Tab>
    <video
      ...
      controls
    >
      <source src="https://github.com/danny-avila/MyLinks/assets/32828263/0464f122-eb20-49cd-b201-57db50c57376" />
    </video>
  </Tabs.Tab>

---
title: 🐋 Docker
description: How to install MyLinks locally with Docker
---
...
```bash filename="Navigate to the MyLinks Directory"
cd MyLinks
```
...
```sh filename="Start MyLinks"
docker compose up -d
```

<Callout type="success" title="Access MyLinks!" emoji="🎉">

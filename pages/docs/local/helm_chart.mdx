...
## Configuration
Similar to other Helm charts, there exists a [values file](https://github.com/danny-avila/MyLinks/blob/main/helmchart/values.yaml) that serves two primary functions: it outlines the default settings and indicates which configurations are adjustable.
...
```
  env:
    ...
    # https://github.com/danny-avila/MyLinks/blob/main/.env.example
...
- Example submitted by [@dimaby](https://github.com/dimaby) on GitHub: [PR #2879](https://github.com/danny-avila/MyLinks/pull/2879)
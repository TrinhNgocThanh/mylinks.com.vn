---
title: 🪖 Helm Chart
description: Instructions for deploying MyLinks on Kubernetes using Helm
---

# Deployment a MyLinks Helm Chart

The following instructions guide you to deploy MyLinks on Kubernetes using Helm. At the moment, this installation method only provides running the MyLinks components, without any additional services like MongoDB or Redis. You will need to provide your own MongoDB and Redis instances.
...
## Configuration
Similar to other Helm charts, there exists a [values file](https://github.com/TrinhNgocThanh/mylinks.com.vn/blob/main/helmchart/values.yaml) that serves two primary functions: it outlines the default settings and indicates which configurations are adjustable.
...
```
  env:
    ...
    # https://github.com/TrinhNgocThanh/mylinks.com.vn/blob/main/.env.example
...
- [MyLinks Helm Chart by Blue Atlas Helm Charts](https://github.com/bat-bs/helm-charts/tree/main/charts/librechat)
- Example submitted by [@dimaby](https://github.com/dimaby) on GitHub: [PR #2879](https://github.com/TrinhNgocThanh/mylinks.com.vn/pull/2879)
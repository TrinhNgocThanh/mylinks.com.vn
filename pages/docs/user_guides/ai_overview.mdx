---
title: AI Overview
description: Understand the pre-configured endpoints in MyLinks
---

# AI Overview

MyLinks allows you to configure and integrate various AI providers, APIs, and their corresponding credentials. This enables you to utilize different AI models, settings, and functionalities based on your needs and requirements.
...
4. **Set Default Endpoint and Preset**: Specify a default endpoint and preset to streamline the process of starting new conversations. Here's a video to demonstrate: **[Setting a Default Preset](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/bbde830f-18d9-4884-88e5-1bd8f7ac585d)**

...
- Fork the MyLinks repository: [https://github.com/TrinhNgocThanh/mylinks.com.vn/fork](https://github.com/TrinhNgocThanh/mylinks.com.vn/fork)
...
<Callout type="info" title="Screenshots:" emoji="📷" collapsible>
  ![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/c4cff4d5-70ea-4263-9156-e7f220e049eb)
  ![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/8ec85f02-f0f7-4cef-bb1c-6ff1bd1d7023)
  ![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/09e4ea5c-0753-470d-a0c5-8281a523a81b)
</Callout>

- Download your new branch to your local PC

```sh filename="Download your MyLinks branch"
git clone -b branch-name https://github.com/username/MyLinks.git
```
...
- After cloning your branch:
  ```sh filename="Navigate to MyLinks folder"
  cd MyLinks
  ```
...
- ```sh filename="Install MyLinks dependencies"
  npm ci
  ```
...
For efficient work on MyLinks, use these commands:
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/4da0a287-e6d3-4e75-af6b-4cffc28f593c)
...
<Callout type="tip" title="Tip">
  ...
  ![image](https://github.com/Berry-13/MyLinks/assets/81851188/a04a7e81-7c75-4c77-8463-d35f603bedf7)
</Callout>

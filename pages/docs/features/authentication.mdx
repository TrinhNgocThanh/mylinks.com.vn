...
<div style={{padding: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
  <div className="image-light-theme">
    ![Image for Light Theme](https://github.com/danny-avila/MyLinks/assets/32828263/786fa525-73c4-4640-b4cf-91925ad8802e)
  </div>

  <div className="image-dark-theme">
    ![Image for Dark Theme](https://github.com/danny-avila/MyLinks/assets/32828263/dddc34c6-9602-4177-89e8-4c0db01b0eac)
  </div>
</div>
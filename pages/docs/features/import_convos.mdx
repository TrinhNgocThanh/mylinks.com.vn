...
<div style={{padding: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
  <div className="image-light-theme">
    ![Image for Light Theme](https://github.com/danny-avila/MyLinks/assets/32828263/3c71b4f8-3d67-4293-ae89-fea4c59312d8)
  </div>

  <div className="image-dark-theme">
    ![Image for Dark Theme](https://github.com/danny-avila/MyLinks/assets/32828263/14151a19-94ca-45b3-a79e-134d961e474c)
  </div>
</div>
...
<div style={{padding: "20px", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
    ![import-success](https://github.com/danny-avila/MyLinks/assets/32828263/597eefec-0b8e-4fbf-ac27-2405472c195f)
</div>

---
title: Custom Config
description: Comprehensive guides for configuring the `librechat.yaml` file AKA the MyLinks Config file. This section is your one-stop resource for understanding and customizing endpoints & other integrations.
weight: -11
---

# Intro

Welcome to the guide for configuring the **librechat.yaml** file in MyLinks.
...
<div style={{ display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
  <div className="image-light-theme">
    <img src="https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/26336fa4-db61-438b-929c-0004aa4db56c" alt="modelmenu-light" style={{ width: "75%", height: "75%" }} />
  </div>

  <div className="image-dark-theme">
    <img src="https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/1e2fe33b-7073-4b4e-9ee1-7b7a99704bad" alt="modelmenu-dark" style={{ width: "75%", height: "75%" }} />
  </div>
</div>
...
Stay tuned for ongoing enhancements to customize your MyLinks instance!

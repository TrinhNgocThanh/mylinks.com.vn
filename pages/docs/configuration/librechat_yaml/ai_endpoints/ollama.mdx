...
```yaml filename="librechat.yaml"
  custom:
    - name: "Ollama"
      apiKey: "ollama"
      # use 'host.docker.internal' instead of localhost if running MyLinks in a docker container
...
![image](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/110412045/57460b8c-308a-4d21-9dfe-f48a2ac85099)

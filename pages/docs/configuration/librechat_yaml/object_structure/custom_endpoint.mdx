...
iconURL: https://github.com/TrinhNgocThanh/mylinks.com.vn/raw/main/docs/assets/MyLinks.svg
```
**Notes:**
...
<OptionTable
  options={[
    ['userIdQuery', 'Boolean', 'When set to `true`, adds the MyLinks user ID as a query parameter to the API models request.', ''],
  ]}
/>

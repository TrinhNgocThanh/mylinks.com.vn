---
title: Meilisearch
description: Setting up MeiliSearch for MyLinks
---

# Setting up MeiliSearch for MyLinks
- See: [Search feature in MyLinks](/docs/features/search) for a quick overview.

MeiliSearch is a powerful, open-source search engine that enhances MyLinks's functionality by enabling full-text search, typo tolerance, and instant search results for past conversations. 

Follow these steps to set up MeiliSearch for MyLinks:
...
## 6. Update MyLinks's Environment Variables
    - Open the `.env` file in the root directory of your MyLinks project.
...
## 7. Start/Restart MyLinks
    - Start or restart your MyLinks application.

That's it! With MeiliSearch set up and configured, MyLinks should now have the Conversation search feature enabled, allowing users to perform full-text searches, benefit from typo tolerance, and experience instant search results for their past conversations.

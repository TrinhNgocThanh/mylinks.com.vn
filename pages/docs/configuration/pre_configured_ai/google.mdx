...
![image](https://github.com/danny-avila/MyLinks/assets/110412045/728cbc04-4180-45a8-848c-ae5de2b02996)
...
2. Create a Service Account with Vertex AI role:
  ...
  - Enter a service account ID (required), name and description are optional
      - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/0c5cd177-029b-44fa-a398-a794aeb09de6)
  - Click on "Create and Continue" to give at least the "Vertex AI User" role
      - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/22d3a080-e71e-446e-8485-bcc5bf558dbb)
...
3. Create a JSON key to Save in your Project Directory:
  ...
  - Click on "Keys"
       - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/735a7bbe-25a6-4b4c-9bb5-e0d8aa91be3d)
  - Click on "Add Key" and then "Create new key"
       - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/cfbb20d3-94a8-4cd1-ac39-f9cd8c2fceaa)
  ...
  - **Save it within the project directory, in `/api/data/`**
       - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/f5b8bcb5-1b20-4751-81a1-d3757a4b3f2f)

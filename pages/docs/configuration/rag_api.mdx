...
4. Craft your prompts carefully when you attach files as the default behavior is to query the vector store upon every new message to a conversation with a file attached. 
    ...
    - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/29a2468d-85ac-40d7-90be-a945301c5729)
5. You only have to upload a file once to use it multiple times for RAG.
    ...
    - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/b40cb3d3-e6e7-46ec-bc74-65d194f55a1e)
    ...
    - ![image](https://github.com/danny-avila/MyLinks/assets/110412045/1f27e974-4124-4ee3-8091-13514cb4cbca)

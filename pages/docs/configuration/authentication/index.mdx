...
description: This guide explains how to use the user authentication system of MyLinks, which offers secure and easy email and social logins. You will learn how to set up sign up, log in, password reset, and more.
--- 
...
<div style={{display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column"}}>
  <div className="image-light-theme">
    ![register-light](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/4c51dc25-31d3-4c51-8c2a-0cdfb5a25033)
  </div>

  <div className="image-dark-theme">
    ![register](https://github.com/TrinhNgocThanh/mylinks.com.vn/assets/32828263/3bc5371d-e51d-4e91-ac68-56db6e85bb2c)
  </div>
</div>
...
- Default values: session expiry: 15 minutes, refresh token expiry: 7 days
  - For more information: **[GitHub PR #927 - Refresh Token](https://github.com/TrinhNgocThanh/mylinks.com.vn/pull/927)**
...
2. For the deploy-compose.yml:
   ```
   docker exec -it MyLinks-API /bin/sh -c "cd .. && npm run create-user"
   ```
...
2. For the deploy-compose.yml:
   ```
   docker exec -it MyLinks-API /bin/sh -c "cd .. && npm run delete-user email@domain.com"
   ```

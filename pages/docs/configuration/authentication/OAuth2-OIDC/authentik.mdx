---
title: Authentik
description: Learn how to configure MyLinks to use Authentik for user authentication.
---
...
- You can name the application whatever you want. For this example, we will name it `MyLinks` and click next.
...
> Note: You should also apply any policies for access control that you want to apply to MyLinks at this point.
...
- Restart MyLinks to apply the changes.
- Open an Icognito window and navigate to your MyLinks instance.
...
- After logging in you should be redirected back to MyLinks and be logged in.
    - If you are not redirected back to MyLinks, check Authentik logs for any errors.
...
description: This doc explains how to use the logging feature of MyLinks, which saves error and debug logs in the `/api/logs` folder. You can use these logs to troubleshoot issues, monitor your server, and report bugs. You can also disable debug logs if you want to save space.
---

### General

MyLinks has central logging built into its backend (api).
...
Debug logs are essential for developer work and fixing issues. If you encounter any problems running MyLinks, reproduce as close as possible, and **[report the issue](https://github.com/TrinhNgocThanh/mylinks.com.vn/issues)** with your logs found in `./api/logs/debug-%DATE%.log`. 

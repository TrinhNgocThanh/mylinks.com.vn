...
Debug logs are essential for developer work and fixing issues. If you encounter any problems running MyLinks, reproduce as close as possible, and **[report the issue](https://github.com/danny-avila/MyLinks/issues)** with your logs found in `./api/logs/debug-%DATE%.log`. 
